...
@@ -103,7 +105,7 @@ def lambdafunc(seq):
# 
#     ['soup','salad']
...
@@ -114,8 +116,21 @@ def caught_speeding(speed, is_birthday):
...
## Numpy Exercises
@@ -128,8 +143,7 @@ def create_arr_of_fives():
